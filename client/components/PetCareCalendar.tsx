...
export function PetCareCalendar({ className }: PetCareCalendarProps) {
  ...
  const petCareData: Record<string, PetCareItem[]> = {
    Monday: [
      {
        id: "1",
        petName: "Max",
    ...
    Wednesday: [
      ...
      },
      {
        ...
        type: "vaccine",
        title: "FVRCP Vaccine",
        description: "Feline core vaccines",
        time: "11:00",
    ...
    Thursday: [
      ...
      },
      {
        ...
        type: "food",
        title: "Special Diet",
        description: "Weight management food",
        time: "12:00",
    ...
    Friday: [
      {
        ...
        type: "food",
        title: "Treats & Play",
        description: "Interactive feeding puzzle",
        time: "16:00",
