...
export function Settings({ className }: SettingsProps) {
  ...
  const handleSaveSettings = () => {
    console.log("Saving settings:", { notifications, preferences, privacy, sounds });
  ...
  const renderProfileSettings = () => (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-card border-border">
        <h3 className="text-lg font-semibold text-foreground mb-4">Veterinarian Information</h3>
        <div className="space-y-4">
          <div>
            <label className="text-sm font-medium text-foreground mb-2 block">Primary Veterinarian</label>
            <input
              type="text"
  ...
  const renderNotificationSettings = () => (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-card border-border">
        <h3 className="text-lg font-semibold text-foreground mb-4">Reminder Settings</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-foreground">Vaccine Reminders</p>
              <p className="text-sm text-muted-foreground">Get notified before vaccines are due</p>
            </div>
            <button
            ...
            >
              <span
                className={cn(
                  "inline-block h-4 w-4 transform rounded-full bg-white transition-transform",
                  notifications.vaccineReminders ? "translate-x-6" : "translate-x-1"
                )}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Get reminded of meal times</p>
            </div>
            <button
      ...
      <Card className="p-6 bg-card border-border">
        <h3 className="text-lg font-semibold text-foreground mb-4">Sound Settings</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {sounds.notifications ? <Volume2 className="h-5 w-5 text-muted-foreground" /> : <VolumeX className="h-5 w-5 text-muted-foreground" />}
              <div>
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <button
            ...
            className={cn(
              ...
              preferences.theme === 'light' ? "border-primary bg-primary/10" : "border-border hover:bg-accent"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "p-4 rounded-lg border text-center transition-colors",
              preferences.theme === 'dark' ? "border-primary bg-primary/10" : "border-border hover:bg-accent"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "p-4 rounded-lg border text-center transition-colors",
              preferences.theme === 'auto' ? "border-primary bg-primary/10" : "border-border hover:bg-accent"
            )}
          >
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-foreground mb-2 block">Time Format</label>
            <select
  ...
  const renderDataSettings = () => (
    <div className="space-y-6">
      <Card className="p-6 bg-card border-border">
        <h3 className="text-lg font-semibold text-foreground mb-4">Data Export & Import</h3>
        <div className="space-y-4">
          <div>
            <p className="font-medium text-foreground mb-2">Export Your Data</p>
            <p className="text-sm text-muted-foreground mb-4">
              Download a copy of all your pet data including profiles, schedules, and health records
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Import pet data from a previously exported file or another pet care app
            </p>
          ...
          <Card className="p-4 bg-card border-border">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-foreground capitalize">{preferences.theme}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Language:</span>
                <span className="text-foreground">{preferences.language === 'en' ? 'English' : preferences.language}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Units:</span>
                <span className="text-foreground capitalize">{preferences.units}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Notifications:</span>
                <Badge variant={notifications.email || notifications.push ? "default" : "secondary"}>
                  {notifications.email || notifications.push ? "Enabled" : "Disabled"}
                </Badge>
              </div>
            </div>
          </Card>
