...
export function CalendarEditor({ className }: CalendarEditorProps) {
  ...
  const saveItem = () => {
    ...
    alert(
      `Item would be saved: ${editingItem.title} on ${editingItem.day} at ${editingItem.time}`,
    );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setEditingItem({ ...editingItem, day: value })
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditingItem({ ...editingItem, petName: e.target.value })
                }
